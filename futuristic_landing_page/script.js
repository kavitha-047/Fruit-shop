...
juiceArray.forEach((element, index) => {
  element.addEventListener("click", () => {
    ...
    main.style.background = juiceData[index].backgroundColor;
...
// Auto Rotate Juice Every 5 Seconds
let currentIndex = 0;
setInterval(() => {
  currentIndex = (currentIndex + 1) % juiceData.length;
  juiceArray[currentIndex].click();
}, 5000);
